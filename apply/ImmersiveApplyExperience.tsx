    ...
    <div className="imm-viewport relative isolate overflow-x-hidden text-ivory">
      ...
      {phase === "questions" && cur && (
        <div className="imm-viewport relative z-10 flex flex-col">
          ...
          <div
            ref={panelRef}
            className="max-h-[56svh] overflow-y-auto rounded-t-[28px] border-t border-x border-gold/15 bg-[rgba(13,11,13,0.78)] px-6 pb-[calc(env(safe-area-inset-bottom)+1.1rem)] pt-6 backdrop-blur-sm"
          >
